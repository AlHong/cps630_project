  ...
  var maxViews, minLikes, dislikePercentage;
  ...
  function searchInput(){
    ...
    minLikes = parseInt(document.getElementById("minLikes").value, 10);
    dislikePercentage = parseFloat(document.getElementById("dislikePercentage").value);

    if(input == "" || maxViews =="" || minLikes =="" || dislikePercentage == "") {
  ...
  function search(){
    ...
    nextPageToken = '';
      ...
      $.get(url).then(function(data){
          ...
          console.log('maxviews' + maxViews+ 'minlikes' +minLikes);
          console.log(data);
  ...
  function sortVideos(data2){
    ...
    for (i = 0; i < data2.items.length  &&  data2.items[i].statistics != undefined; i++){
      ...
      if (data2.items[i].statistics.likeCount > minLikes && data2.items[i].statistics.dislikeCount < (dislikePercentage * data2.items[i].statistics.likeCount)
        && data2.items[i].statistics.viewCount < maxViews) {
